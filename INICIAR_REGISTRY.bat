...
start "EV_Registry (PC A)" cmd /k "python ev_registry\EV_Registry.py --db-host !DB_HOST! --db-port !DB_PORT! --db-user !DB_USER! --db-password !DB_PASS! --db-name !DB_NAME! --port 8000 !SSL_CMD!"
